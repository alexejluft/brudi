---
name: designing-award-layouts-core
description: Use when establishing the foundational design system for award-level layouts. Covers spacing, dark theme layering, typography scales, visual hierarchy, mobile-first strategy, and pre-build checklist.
---

# Designing Award Layouts — Core System
...
See also: `designing-award-navigation`, `designing-award-motion`
