...
## 8. Scroll Indicator — Required on Hero Sections
...
- Respect `prefers-reduced-motion` — disable animation, keep the indicator visible

---

## 9. Mobile Navigation — Close Button Required
...
## 10. Placeholder Images — Unsplash Direct URLs
